  ...
  <div class="flex flex-col gap-8">
    ...
    >
      <div class="flex flex-col gap-2">
        <div class="flex items-center gap-3">
          <div
            class="flex size-10 items-center justify-center rounded-md border border-border bg-background text-foreground"
          >
            <LayoutDashboard />
          </div>
      ...
      <Card size="sm">
        ...
        <CardContent>
          <p class="text-sm text-muted-foreground">
            Git projects in the active project
          </p>
        </CardContent>
      </Card>
    ...
    {:else}
      <div class="grid min-w-0 gap-6 lg:grid-cols-[minmax(0,1fr)_320px]">
        <Card class="min-w-0 h-fit overflow-hidden">
          <CardHeader class="border-b">
            <div class="flex items-center justify-between gap-4">
              <div class="grid gap-1">
                <CardTitle>Recent Applications</CardTitle>
                <CardDescription
                  >Latest applications and their runtime state.</CardDescription
                >
              </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead class="hidden w-[24%] xl:table-cell">Updated</TableHead>
                  ...
                  {#each Array.from({ length: 3 }) as _}
                    <TableRow>
                      ...
                      <TableCell class="hidden xl:table-cell"
                        ><Skeleton class="h-5 w-24" /></TableCell
                      >
                      <TableCell class="text-right"
                        ><Skeleton class="ml-auto h-8 w-20" /></TableCell
                      >
                    </TableRow>
                  {/each}
                {:else}
                    ...
                    <TableRow>
                      <TableCell>
                        <div class="flex min-w-0 items-center gap-3">
                          <div
                            class="flex size-9 shrink-0 items-center justify-center rounded-md border border-border bg-background"
                          >
                            <Server class="size-4" />
                          </div>
                          <div class="min-w-0">
        ...
        <Card class="overflow-hidden">
          ...
          <CardFooter class="border-t">
            <p class="text-xs text-muted-foreground">
              Version {$healthStore?.version || "0.0.0"}
            </p>
          </CardFooter>
        </Card>
      </div>
