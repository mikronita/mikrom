    ...
    pub fn run_zero_downtime_flow(
        ...
        tokio::spawn(async move {
            ...
            let result = async {
                ...
                let max_attempts =
                    crate::deploy::service::DeploymentService::zero_downtime_health_check_max_attempts();
                let health_check_timeout =
                    crate::deploy::service::DeploymentService::zero_downtime_health_check_request_timeout();
                for attempt in 1..=max_attempts {
                    ...
                    tokio::time::sleep(Duration::from_secs(
                        crate::deploy::service::ZERO_DOWNTIME_HEALTH_CHECK_RETRY_DELAY_SECS,
                    ))
                    .await;
                }
