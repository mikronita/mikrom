...
pub mod scheduler_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn watch_apps(
            &mut self,
            request: impl tonic::IntoRequest<super::WatchAppsRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WatchAppsResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mikrom.scheduler.v1.SchedulerService/WatchApps",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("mikrom.scheduler.v1.SchedulerService", "WatchApps"),
                );
            self.inner.server_streaming(req, path, codec).await
        }
    }
...
pub mod scheduler_service_server {
    ...
    pub trait SchedulerService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn list_workers(
            ...
            tonic::Status,
        >;
        /// Server streaming response type for the WatchApps method.
        type WatchAppsStream: tonic::codegen::tokio_stream::Stream<
                Item = std::result::Result<super::WatchAppsResponse, tonic::Status>,
            >
            + std::marker::Send
            + 'static;
        async fn watch_apps(
            &self,
            request: tonic::Request<super::WatchAppsRequest>,
        ) -> std::result::Result<tonic::Response<Self::WatchAppsStream>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/mikrom.scheduler.v1.SchedulerService/WatchApps" => {
                    #[allow(non_camel_case_types)]
                    struct WatchAppsSvc<T: SchedulerService>(pub Arc<T>);
                    impl<
                        T: SchedulerService,
                    > tonic::server::ServerStreamingService<super::WatchAppsRequest>
                    for WatchAppsSvc<T> {
                        type Response = super::WatchAppsResponse;
                        type ResponseStream = T::WatchAppsStream;
                        type Future = BoxFuture<
                            tonic::Response<Self::ResponseStream>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SchedulerService>::watch_apps(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
