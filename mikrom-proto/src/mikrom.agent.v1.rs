...
pub mod agent_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mikrom.agent.v1.AgentService/PauseVm",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mikrom.agent.v1.AgentService", "PauseVm"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mikrom.agent.v1.AgentService/ResumeVm",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mikrom.agent.v1.AgentService", "ResumeVm"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn delete_vm(
            &mut self,
            request: impl tonic::IntoRequest<super::DeleteVmRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteVmResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/mikrom.agent.v1.AgentService/DeleteVm",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("mikrom.agent.v1.AgentService", "DeleteVm"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod agent_service_server {
    ...
    pub trait AgentService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn delete_vm(
            &self,
            request: tonic::Request<super::DeleteVmRequest>,
        ) -> std::result::Result<
            tonic::Response<super::DeleteVmResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/mikrom.agent.v1.AgentService/PauseVm" => {
                    #[allow(non_camel_case_types)]
                    struct PauseVmSvc<T: AgentService>(pub Arc<T>);
                    impl<
                        T: AgentService,
                    ...
                    for PauseVmSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentService>::pause_vm(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/mikrom.agent.v1.AgentService/ResumeVm" => {
                    #[allow(non_camel_case_types)]
                    struct ResumeVmSvc<T: AgentService>(pub Arc<T>);
                    impl<
                        T: AgentService,
                    ...
                    for ResumeVmSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentService>::resume_vm(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/mikrom.agent.v1.AgentService/DeleteVm" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteVmSvc<T: AgentService>(pub Arc<T>);
                    impl<
                        T: AgentService,
                    > tonic::server::UnaryService<super::DeleteVmRequest>
                    for DeleteVmSvc<T> {
                        type Response = super::DeleteVmResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AgentService>::delete_vm(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
